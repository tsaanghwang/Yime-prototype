...
1. 请明确客户名称、客户项目名称、交付类型以及本次许可证是否仅覆盖单一客户和单一项目。
2. 如终端客户需要获得源码、复制权或后续维护权，应在“授权范围”与“期限、终止与后续处理”中写清。
3. 如交付合同与商业许可证并行存在，应注意区分交付义务和许可证义务的承担主体。
...
- 许可方：Huang Chang（或其指定主体）
- 被许可方：________________

## 1. Parties

- Licensor: Huang Chang (or an entity designated by Huang Chang)
...
- 授权交付物：源代码 / 二进制 / 文档 / 其他：________________

## 2. Licensed Project and Materials

- Project name: YIME
- Licensed version or code scope: ________________
- Licensed deliverables: source code / binaries / documentation / other: ________________

## 3. 许可用途

- 客户名称：________________
- 客户项目名称：________________
- 交付类型：定制开发 / 外包交付 / 系统集成 / 其他：________________
...
- 是否允许把 YIME 纳入本次交付成果：允许 / 不允许
- 是否允许客户内部部署：允许 / 不允许
- 是否允许客户获得源码：允许 / 不允许
- 是否允许交付后继续复制到其他客户项目：允许 / 不允许

## 4. Scope of Rights

- Inclusion of YIME in the deliverable for this project: allowed / not allowed
- Internal deployment by the client: allowed / not allowed
- Delivery of source code to the client: allowed / not allowed
- Reuse in other client projects after delivery: allowed / not allowed

## 5. 授权限制

- 本授权默认仅覆盖本次明确列明的客户与项目。
- 未经书面同意，被许可方不得将同一授权自动扩展到其他客户、其他项目或后续运维合同。
- 如客户要求直接取得更广泛权利，应由客户或被许可方另行申请补充授权。
...
- Charged on a per-project basis: yes / no
- Charged by number of clients or delivery batches: yes / no

## 7. 期限、终止与后续处理

- 生效日期：________________
- 授权期限：________________
- 终止条件：________________
- 项目结束后未获继续授权的副本是否应删除或停用：是 / 否
- 后续维护、续费与扩容机制：________________

## 7. Term, Termination, and Post-Termination Handling
...
- Custom development: yes / no
- Defect-fix support: yes / no

## 9. 知识产权、保密与标识

- YIME 及其原始代码、文档和标识的知识产权归许可方所有。
- 是否将源代码、项目文档、交付清单和商务条件纳入保密范围：是 / 否
- 是否允许被许可方或终端客户使用项目名称或许可方名称进行宣传：允许 / 不允许
...
- 被许可方负责与客户合同中的交付义务、验收义务和项目管理责任。
- 除非另有书面约定，许可方不直接对终端客户承担交付、验收或驻场支持义务。
- 适用法律与争议解决方式：________________
...
- 许可方签字/盖章：________________
- 被许可方签字/盖章：________________
- 签署日期：________________

## 11. Signatures

- Licensor signature/seal: ________________
- Licensee signature/seal: ________________
