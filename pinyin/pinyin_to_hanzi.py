# 读取pinyin\toned_pinyin.yaml文件数据
# 创建由带调拼音到汉字的映射字典
# 1. 保留原ymal文件包含的所有不同的拼音形式
# 2. 保留每个不同的拼音对应的所有的不同汉字
# 3. 把生成的字典写入pinyin/pinyin_to_hanzi.json文件中
import yaml
import json
...
if __name__ == "__main__":
    ...
    output_file = "pinyin/pinyin_to_hanzi.json"
