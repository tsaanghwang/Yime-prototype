# 商业许可证说明 / Commercial License Notice
...
1. 将本项目或其修改版出售、捆绑销售，或作为付费软件的一部分提供。
2. 将本项目集成到收费产品、SaaS 服务、企业内部收费系统或客户交付项目中。
3. 使用本项目直接支持营利性业务流程、商业运营或面向客户的商业服务。
4. 以商业品牌、商业组织或商业合同为背景部署本项目，且该部署与收入、成本节约或商业交付直接相关。

如果您无法判断自己的使用是否属于商用，请先按商用处理并联系作者确认。

### 商业许可证通常可约定的范围

商业许可证可根据实际需求单独协商，常见内容包括：

1. 授权主体、授权对象与授权范围。
2. 可部署的产品、服务、项目或客户范围。
3. 是否允许闭源集成、再分发、定制开发、托管服务或技术支持。
4. 授权期限、地域、费用、续期方式与终止条件。

除非双方另有书面约定，商用权利不会因本仓库公开可见而自动授予。

如双方进入正式交易流程，具体权利义务应以双方签署的商业许可证合同文本为准。
...
1. 您的姓名或机构名称。
2. 预计使用方式。
3. 是否涉及对外销售、收费服务、SaaS 托管或客户交付。
4. 预计部署规模、期限与是否需要技术支持。
...
To help evaluate the request efficiently, please include:
