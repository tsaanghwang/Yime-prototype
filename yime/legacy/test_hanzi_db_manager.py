...
class Test拼音信息(unittest.TestCase):
    ...
    def test_拼音信息创建(self):
        """测试拼音信息创建"""
        from yime.legacy.pending_removal.hanzi_db_manager import 拼音信息
...
class Test数据库管理器(unittest.TestCase):
    ...
    def test_上下文管理器进入(self):
        """测试上下文管理器进入"""
        from yime.legacy.pending_removal.hanzi_db_manager import 数据库管理器
...
class Test表管理器(unittest.TestCase):
    ...
    def test_创建表_基本结构(self):
        """测试创建基本表结构"""
        from yime.legacy.pending_removal.hanzi_db_manager import 表管理器
