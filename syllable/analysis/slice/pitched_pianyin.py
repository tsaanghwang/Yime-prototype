...
supporting various representation methods.
#
乐音 (Yueyin) 由音质和音高(与音质联结的调段)构成. 乐音的音高特指与乐音的音质联结的调段.
音质 (quality): 必选属性
音调 (pitch): 必选属性
#
...
# Define a minimal PitchedPianyin base class if not imported from elsewhere
