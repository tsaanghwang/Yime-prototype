...
if __name__ == "__main__":
    ...
    # 对单质干音应用 _i 类音元增强
    if "single quality ganyin" in result:
        result["single quality ganyin"] = enhance_i_variants(result["single quality ganyin"])
        # 重新保存增强后的结果
        converter.save_yinyuan_data(str(output_file), result)
