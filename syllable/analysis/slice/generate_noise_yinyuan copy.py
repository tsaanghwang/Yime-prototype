"""
根据重构的syllable\analysis\slice\yinyuan.py和syllable\analysis\slice\indeterminate_pitch_yinyuan.py
修改当前模块：syllable\analysis\slice\generate_noise_yinyuan.py
...
def generate_unpitched_yinyuan():
    ...
    # 5. 写入输出文件
    output_path = 'syllable/analysis/slice/unpitched_yinyuan.json'
