...
- 产品类型：桌面软件 / 服务端产品 / 嵌入式系统 / 其他：________________
- 计划集成的 YIME 范围：________________
...
- 是否允许闭源分发：允许 / 不允许
- 是否允许修改源码后嵌入产品：允许 / 不允许
- 是否允许在多个版本线中复用：允许 / 不允许
- 是否允许由关联公司共同使用：允许 / 不允许

## 4. Scope of Rights

- Closed-source distribution: allowed / not allowed
- Modified-source embedding into the product: allowed / not allowed
- Reuse across multiple product lines: allowed / not allowed
...
- 是否限定特定提交、分支或发布版本：是 / 否
- 后续升级是否自动纳入：是 / 否
- 终止后的停止分发、下架、替换或删除义务：________________
...
- Compatibility support: yes / no

## 9. 知识产权、保密与标识

- YIME 及其原始代码、文档和标识的知识产权归许可方所有。
- 是否将源代码、集成文档和未公开商务条件纳入保密范围：是 / 否
- 是否允许在产品材料中使用项目名称或许可方名称：允许 / 不允许
...
- 超范围集成、超范围分发或未经许可转授权，应视为重大违约。
- 许可方可要求停止分发、删除未授权版本并补签商业许可证或承担违约责任。
